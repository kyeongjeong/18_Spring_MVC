...
public class MapperBasic {
	...
	@Autowired // @Inject
	private SqlSession sqlSession; // root-context.xml파일에서 생성된 객체를 주입
	...
	// selectList("namespace.id") 예시
	public void ex01() {
		sqlSession.selectList("basic.ex01");
	}
	
	// selectOne("namespace.id") 예시
	public void ex02() {
		sqlSession.selectOne("basic.ex02" , "데이터");
	}
	
	// insert("namespace.id") 예시
	public void ex03() {
		sqlSession.insert("basic.ex03" , "데이터");
	}
	
	// update("namespace.id") 예시
	public void ex04() {
		sqlSession.update("basic.ex04" , "데이터");
	}
	
	// delete("namespace.id") 예시
	public void ex05() {
		sqlSession.delete("baisc.ex05" , "데이터");
	}
